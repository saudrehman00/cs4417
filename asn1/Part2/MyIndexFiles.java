...
public class MyIndexFiles {
  ...
  public static void main(String[] args) {
    ...
    // Turn it into CharArraySet
    final List<String> wordList = Arrays.asList("about", "dost", "from", "hath", "his", "O", "that", "the", "thou");
    final CharArraySet wordCharArraySet = new CharArraySet(wordList, false);
